...
public class Main {
	...
	public static void main(String[] args) {
		...
		Queue<Integer> queueSample = new PriorityQueue<Integer>();
		...
		sw.stop();
		System.out.println("Time to add elements in an ArrayList:" + listAddTime);
		System.out.println("Time to find element in an ArrayList:" + sw.getElapsedTime());
		...
		sw.stop();
		System.out.println("Time to add element in a PriorityQueue:" + listQTime);
		System.out.println("Time to find element in a PriorityQueue:" + sw.getElapsedTime());
		...
		System.out.println("Time to find element in a TreeSet:" + sw.getElapsedTime());
