...
/**
 * This Demo uses RuntimeExceptions to demonstrate try-catch blocks. Normally we
 * handle RuntimeExceptions with defensive coding, but here they help us
 * simulate checked exception handling.
 */
...
public class ExceptionPropagationExample {
	...
	private static void divideSafely(String[] array) {
		...
		try {
			...
			System.out.println("Result: " + divideArray(array));
		...
		System.out.println("Life after try-catch...");

	}

	private static int divideArray(String[] array) throws ArithmeticException,
